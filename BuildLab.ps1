...
Begin
{
    ...
    {
        $Settings.VMs.Values.Name | Where-Object { $_ -notmatch 'DC' } | ForEach-Object { $VMsJoined.Add($_, $true) }
    }
...
Process
{
    ...
    foreach($VM in $Settings.VMs.GetEnumerator())
    {
        if ($VM.Value.Domain)
        {
            ...
            if (Wait-For @WaitSplat @VerboseSplat -VMName $VM.Value.Name -Queue $VMsInstalled)
            {
                ...
                if ($Result.Joined)
                {
                    $VMsJoined.Add($Result.Joined, $true)
                }
            }
        }
    }
    ...
    # Root cdp
    if (Wait-For @WaitSplat @VerboseSplat -VMName $Settings.VMs.AS01.Name -Queue $VMsJoined)
    {
    ...
    if (Wait-For @WaitSplat @VerboseSplat -VMName $Settings.VMs.CA02.Name -Queue $VMsJoined)
    {
        $Result = Invoke-Wend -TryBlock {
    ...
    if (Wait-For @WaitSplat @VerboseSplat -VMName $Settings.VMs.ADFS01.Name -Queue $VMsJoined)
    {
    ...
    if (Wait-For @WaitSplat @VerboseSplat -VMName $Settings.VMs.WAP02.Name -Queue $VMsJoined)
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNfCMlefsKed9kCmq/DHFF2Rn
# H3+gghgSMIIFBzCCAu+gAwIBAgIQJTSMe3EEUZZAAWO1zNUfWTANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUzRHuaTH8
# 65Djf/5Lf/8agAA2ZSAwDQYJKoZIhvcNAQEBBQAEggIAomsrR6qSHXEu4dvY6UxG
# C86rUBW6Pcw/UXrpN9Gb1PDfERwZyA7noRgC50pIaA4WYhVLl72QapYZ8TViNFXb
# vD486odrQbuovdjfUz762RUionESB2/7yhGk8Bp8k5wLtcRq706Kk1h9A9ySW5QM
# J58b5F3fkXa80chePVT2yIGxzxrYJc3bu7SNktEinwZKNe0BanlcCgloLgHtdUYp
# bGUpmaQRet7JvnMIUcWUJXT7y+yk5oLbnN6x8MulSsZGMYpLGRIygZ6DKYrOoN7D
# bkJHhFNBvJBvxVJ6WatfJVL8umjTZQtySMgrU+DbAYjA68ygyt0EhBx8SUK+b5MI
# PjA/sjw1MADJ1YgkXaTukN77k9y+3GP73XCU03HQYTN/KncwKQnvutvd/c+pxUsC
# cDpBxdmRg1LkDsxd0lbbjtTV9EiAKmSighrgGhcUMDAVKUxQOicCznSmlAEEFQzK
# xBymdZ37Y/xMUOHNOc1DFjg5UILpguT4X4KVO0hdh6D4ccX3G4JKSEFgCnGPzKBS
