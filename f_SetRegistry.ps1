...
function Set-Registry
{
    ...
    foreach ($Setting in $Settings)
    {
        ...
        switch($Setting.Path)
        {
            { $_.StartsWith('HKLM:\') }
            {
                $Settings.Path = $Settings.Path.Replace('HKLM:\', 'HKEY_LOCAL_MACHINE\')
            }

            { $_.StartsWith('HKCU:\') }
            {
                $Settings.Path = $Settings.Path.Replace('HKCU:\', 'HKEY_CURRENT_USER\')
            }
        }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7M3KjCRXIrlXWiXyfXSbv2SJ
# CKOgghgSMIIFBzCCAu+gAwIBAgIQJTSMe3EEUZZAAWO1zNUfWTANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUpGizfwiR
# KFh2LSnr9uh3KvdDcwgwDQYJKoZIhvcNAQEBBQAEggIAGeUKoRfp+sTvUv+4G27C
# /WAts6UlwvNHNTslwSRX/stP5dZgOcYYJnUMYAkihQ+2HSJyO301i60iGLrnKqS1
# 7aM5c+gY1GPslfhhJaZnjk13Qbssx+JyTigYjGriu3kdpBFOiVHXloRatWCXqN60
# c3Pkc3QU5mz9ZBiKHQ21tG1oGn94+fOH/ts+/iAiZj131K8E3MNxdY12jvLLVPYw
# BY7p94ZXzgoFos3e7f2mYTi+rpGYB8EuLkCWXm3qkywif1oDszem8eB4LcoNgVff
# ZZrfl5aIwDOx4AWPZYiyIk9glUyMKAG1lkVgNdXL3qMP3gGEl6NxEby755AE1c7B
# wSRtwSRpmv7tlAeAXX9kohk9ej9uWNgiaWX7dW2doeGLF9f7ZAZjeFLPvHsq0dmg
# Zk3tiWmtJ00eBcbqov+aFrq+t2TiyKQLsDWIDh+x9o5xg6/7gxZ2b90mqtHvTP4A
# ENXs5VOj9TesVTnMREHoZqqQyMeYXHqk4N0nGcg24r7SNZMvvpT6gkHoIgHfbOJ6
# Ti9hQi3sj+Txd83pAF6yqTY0ye13CITCvQWnAHIH8U35X3vvXAgz24Uwtsm6J98g
# Hq46czmZSpBbunigI+YDb9hUqGALIOY7EFnSSanwNfVujLDSvIBCgyS1PFcf133L
# +SGw/ViKYy95BLC34OJtq/KhggMgMIIDHAYJKoZIhvcNAQkGMYIDDTCCAwkCAQEw
# dzBjMQswCQYDVQQGEwJVUzEXMBUGA1UEChMORGlnaUNlcnQsIEluYy4xOzA5BgNV
# BAMTMkRpZ2lDZXJ0IFRydXN0ZWQgRzQgUlNBNDA5NiBTSEEyNTYgVGltZVN0YW1w
# aW5nIENBAhAMTWlyS5T6PCpKPSkHgD1aMA0GCWCGSAFlAwQCAQUAoGkwGAYJKoZI
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjIxMjIxMTIwMDAx
# WjAvBgkqhkiG9w0BCQQxIgQg54tFOlshCsc1YdZCNcTli8WvfbAXQ+dACA62gysP
# 9iEwDQYJKoZIhvcNAQEBBQAEggIAgR+IQbmrMlVANjPRubvz5EqWDbmCblcZnivp
# VJ8GCFtclL/YNvRaLyww9vr8B+9PNONzGtkk2IK+fF882JoZ7kEOJMLnSf0ulSns
# mK8ctTDKnI7CXZ+UKSin8ykKqxpyrCtXAsGON3MfKxmSMfKdHc8eDIyMKgvB6YkM
# TnT1QixYXeJ52XHHGw1H0fQN4LL23xmRqvgvGCyiWkU7lrKD9kM230Dfm5JbYSKJ
# E7RDvP2ruEneFX3wQJN9efQBbTmPGXviSL5fWB714kzY2tvQC2BEFOXCkuxArAG9
# 2sKjk8kH8/IharlacLk5M5aCqEgdbJaE494QJeTyrhvc6wZj9Xe1v7aBXah6OHJV
# nD8+iR3Ln/DSvfHHnF3ep9+WB+fmOx1M1kPjNbRT9bnhFI7HyuQ2HnJsNjrLMg9l
# b0IZYa/EMH6qJbMmTVVAECZ1LMaPW7PmPSr24VQ/BP3wLw/bCScGKXBj9Pko9K3N
# LAzcv8wW91KGyqYqQRWd52r79FO7mrX615e2jHYfrqPQjx+cf1b+a++1g7czBf49
# HPr/kWBP2gCwkwB5dIHFMOcFvktBC16dhNq1gDpGENGBAvs4D8/FikyD9MXEAQfl
# H9A1EszZmyMkJMRtAcIvDUlNTHVnavhP8XEmJhvn8afFhGltdigD+dan4lwrKT8D
# siDWWyw=
