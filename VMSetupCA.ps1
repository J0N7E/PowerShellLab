    ...
    if ($ParameterSetName -match 'NewKey.*Subordinate')
    {
        ...
        foreach($file in (Get-Item -Path "$PSScriptRoot\*.cer", "$PSScriptRoot\*.crt"))
        {
                ...
                } | ForEach-Object { "$($Matches[1])" }))
            {
                ...
                Write-Verbose @VerboseSplat -Message "Found parent CA certificate `"$($file.Name)`""
            }
                ...
                } | ForEach-Object { "$($Matches[1])" }))
            {
                ...
                Write-Verbose @VerboseSplat -Message "Found CA certificate response `"$($file.Name)`""
            }
        }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUP0G85U87B8ZNCSGoW5oUAbqD
# E/aggg8yMIIE9zCCAt+gAwIBAgIQJoAlxDS3d7xJEXeERSQIkTANBgkqhkiG9w0B
...
# BAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUALuwP8404DjdPQMGy2w1kNYyNVQwDQYJ
# KoZIhvcNAQEBBQAEggIAP/qwqDvUbzQ4zg96B6uJNV15es/IdyNYBZvGBBpmmTrF
# 2YsIkt3N0llW0EQBvPGFAfkX1vuLOjrnxukwp/mmAq4wbAHEtknsAvp3jKcks48z
# BPclkq8445QNNAWH6CMSbeLMGj4UM79fbmNg+2LegK34jeReQdZc6XHQXLgbSmZb
# 9LAa4coNg5JRYAbbBnoe1+FREfcGLTD1dwF2iQc7bGFZflC1p18dcR7PkWlig9Q3
# VVI5ZC/exReNE6MFgWv4rkr8POm7flRoIOk11oaRm6DdNeyQs4mVVOFansJa7meG
# Ncy4hUizVDvqUu4nDKW2PMYqhyAN5MlYSgrq8BUdqn1SQpSbd/FwKiu0qXDjceLM
# F1503pbfX0WfKETpsyyoC598fW4a7kGpJ7A+dzV4CU0OQF4xuo/QWAlxtFjz037r
# +uKqzkmhd4ZmLKzQFdoSqPZGj61Lo2We1lxhouMhBdxKNcJRdX3mUBlLEXWGy7lA
# WFuS6f6vJv6OcGqixWrKAX7Jb+3l65NpucM2f1SQ14/1AAlgofxvrmZdfhhIxxzs
# EAYgLZE6BJ0zG94cTWpcP8zQqE+LXom/OMZjzvwphPdTuESWnYbkuD/aBUfmUSks
# Z1xh6fXuBvsi27Q31yZHx0Gy+CzPr2JeKr/UhkkAvP2YowEzP67Z8hqJgbeXTn2h
# ggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYwcjELMAkGA1UEBhMCVVMx
# FTATBgNVBAoTDERpZ2lDZXJ0IEluYzEZMBcGA1UECxMQd3d3LmRpZ2ljZXJ0LmNv
# bTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVkIElEIFRpbWVzdGFtcGlu
# ZyBDQQIQDUJK4L46iP9gQCHOFADw3TANBglghkgBZQMEAgEFAKBpMBgGCSqGSIb3
# DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIxMDkxNDE0MDAwMlow
# LwYJKoZIhvcNAQkEMSIEIJl9DxgGzT6ttFfoVrFnBYhhqoVdDOraECOTmboDYyNe
# MA0GCSqGSIb3DQEBAQUABIIBAC6UX1b8n0hy4vvWZbfmuirlYsCHcb85+wQQO23z
# HFLcGJ+mAh/GnevXZ/Tgr+nx2v9ZWc2BZGdCUuzGN94jkXUMsshtu35Tzedjb8MV
# 0n0WIkgLHc+viL/S8C6bH3062IlgvDm6IiD/3xOg0EGig5wlNXYhE5jtLn97gF+H
# wckka30fxUfZSRfv3/n1vQ/eD4mR5iGO+r05V6XKzCJBJKKXugva77E6NGb7a3Kh
# +mdP7JfRdyhmf/IbD0Su4t5r1RFXRGKO/blOifHu9gDQy1g2DjN9S5IjLy6USAeg
# 1kA/E3Vw4HacfE8G92ozkkaM7NvsQlug+H+PBCWdzALpoBU=
