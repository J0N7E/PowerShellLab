...
Process
{
    ...
    if (Wait-For @WaitSplat @VerboseSplat -VMName $Settings.VMs.ROOTCA.Name -Force)
    {
        ...
        .\VMSetupCA.ps1 -Verbose -VMName $Settings.VMs.ROOTCA.Name -Credential $Settings.Lac `
                        ...
                        -CADistinguishedNameSuffix "O=$DomainNetBiosName,C=SE" `
    ...
    if (Wait-For @WaitSplat @VerboseSplat  -VMName $Settings.VMs.AS.Name -Queue $VMsRenamed)
    {
        ...
        .\VMSetupCAConfigureWebServer.ps1 -Verbose -VMName $Settings.VMs.AS.Name -Credential $Settings.Dac `
                                          -Force `
                                          -CAConfig "$($Settings.VMs.ROOTCA.Name).$($Settings.DomainName)\$DomainPrefix Root $($Settings.VMs.ROOTCA.Name)" `
                                          -ConfigureIIS `
    ...
    if ((Get-VM -Name $Settings.VMs.AS.Name -ErrorAction SilentlyContinue).State -eq 'Running')
    {
        ...
        .\VMSetupCAConfigureWebServer.ps1 -Verbose -VMName $Settings.VMs.AS.Name -Credential $Settings.Dac `
                                          -Force `
                                          -CAConfig "$($Settings.VMs.SUBCA.Name).$($Settings.DomainName)\$DomainPrefix Enterprise $($Settings.VMs.SUBCA.Name)" `
                                          -ConfigureOCSP `
    ...
    if (Wait-For @WaitSplat @VerboseSplat  -VMName $Settings.VMs.WAP.Name -Queue $VMsRenamed)
    {
        ...
        .\VMSetupWAP.ps1 -Verbose -VMName $Settings.VMs.WAP.Name -Credential $Settings.Dac `
                         ...
                         -ADFSPfxFile "$($DomainPrefix)AdfsCertificate.pfx"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFRkuDceW1NBVnTCvbcB0oD2W
# pwGgghgSMIIFBzCCAu+gAwIBAgIQJTSMe3EEUZZAAWO1zNUfWTANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUfNxVpzwF
# 9P1NpizdCsGXEVfFIF8wDQYJKoZIhvcNAQEBBQAEggIADZTRk1KQ8RJRSjBbE+Yt
# a0wxrjZHE7oY0/qoOiY1MiBodO/dGmkD0bKFUN0gnqoLuWmCMYz+Ni6s5G6Zp9ft
# oSyTK7qwETscUQ/oiaYgAmZlyYKZNZe8Xaabd/PLEYROcDCSLkYFL8Dx50c0W5t8
# E1z38pMJppm6G9ePg3eKcZhsnRALUEDofedagYiMIVNbicIo1POn8EvEGNGgLdeX
# LhZSbqMXNT+JlfXcnyAiA4JmTyzfI5mZpfz1wrNhN4S+MowdmYFwi9i1LxWHXJ5w
# PXsepzMkh2s5J2EA5iVUfNyuVqcwugqmuuC7lXfNuMLTf6cejhy+SU4VJtVSRH5x
# yMop7KJ6CcZy1AENtm2T9QmwyXgqRsl37H2nTHjCmB3SznosppHJDHJLmheJ//Wp
# 4Hu4ZmseaL3u9K9ytHk8FMO9N7fTc1F/LT4wUq8HO+gLEjagPhnCAC5Ei1/hKr6G
# J4ukDKMMlSVKea9bRk5o3FnX/tXsldpAy0W65GrJnADZ8FihTWQzDJMDwkKxN7wp
# l7HOIerlAqIajxKW140OUfZ9G548M3w23I/HGQLBm1npztu+UmErwQ834T/pG8g/
# F0UaTL1Xt5ASYNiG1FzznONlrAI3+PRe/lYXrTM0Iq8+lgYuuVNRxluvE/1gUdkL
# lxhhOv8j12Nb9L87+gaY01ahggMgMIIDHAYJKoZIhvcNAQkGMYIDDTCCAwkCAQEw
# dzBjMQswCQYDVQQGEwJVUzEXMBUGA1UEChMORGlnaUNlcnQsIEluYy4xOzA5BgNV
# BAMTMkRpZ2lDZXJ0IFRydXN0ZWQgRzQgUlNBNDA5NiBTSEEyNTYgVGltZVN0YW1w
# aW5nIENBAhAMTWlyS5T6PCpKPSkHgD1aMA0GCWCGSAFlAwQCAQUAoGkwGAYJKoZI
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwMjE1MTEwMDAx
# WjAvBgkqhkiG9w0BCQQxIgQgzDXXCFBkclC6foRNkesFKF9fgQJju6+LV5AC1xgN
# ygwwDQYJKoZIhvcNAQEBBQAEggIAWPFpJvPY9FGsVxsIQyd3tpXuNcKPlGRtcB3y
# jZwHxjc0xgXKD7lT/wPT4GUs52y7J9Hn9I+qsoZo/45O+KtyptGBv0xsz41uJrw+
# pSSF7iHBGLQgKym9wZ8m2rEd2c30YjCb+l+ksx2+gdz8D+p8b3DgcXjmmTsdNjiD
# T2d0wjZ1cYU4QeiibKhOem01TikYX7TkVMZLUULgtwzE5o+Xit/SGhh4vLQX5cNu
# z1OxdnZO8SLpsRsReb+OJkKDPV2gs3nWwQGXMFLJI8/GisaR57FXagWTtAzqbsLd
# JiyroksJEqVMz0UgtNovpCQma2Feu+/hcqf6UXV9su6EVtiR3R4yNhAdpyT5O31O
# er/V9S8zN15Y9vUKJCoJMzAAZF+xX1OXFpwJZjRo4UYwaa+4r2JSkFyuubBHGBeh
# LU9Jm97F26DRQ2rQbt9iL/H1xhpNBhLsisd+4S9H2crdUtpO76VokCvnSUPpNE/v
# Ln+4Z47qkFVwJ13NE/pYLyZ0U9cjQ1BDH6Rclw/aCxlJ6gzHitCudz3yJsiRNUmy
# LtCOI3uxDL4A5yFRWgJ/Q5aCByiDs4MPEneO9eO5sgwXPE/8puJkwLwRcDMjfqdF
# egm5QMiRfhOYB2Ae5FUjI0SYvJVDTvgVJsBEQeeP62BUqIiBNDYyabYDT2An9mmB
# 3yZIzwE=
